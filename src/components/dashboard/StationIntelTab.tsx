        ...
        <div className="flex flex-col items-center gap-4 sm:flex-row">
          ...
          <div className="flex-1">
            ...
            <p className="mt-1 font-mono text-[10px] text-muted-foreground">
              Dominant: {station.dominantPollutant.toUpperCase().replace("25", "2.5")} • {station.time.s}
            </p>
          </div>
        </div>
        ...
        <div className="cyber-border rounded-lg p-4">
          ...
          {aiLoading ? (
            <div className="mt-3 flex items-center gap-2 text-muted-foreground">
              ...
              <span className="font-mono text-xs">Analyzing station data...</span>
            </div>
          ) : aiError ? (
            ...
            <div className="mt-3 space-y-3">
              ...
              {ai.trend_analysis && (
                <div>
                  <span className="font-mono text-[10px] text-muted-foreground">TREND ANALYSIS</span>
