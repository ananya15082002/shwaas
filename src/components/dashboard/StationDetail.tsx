          ...
          <div className="p-6">
            ...
            <div className="mt-4 flex flex-col items-center gap-4 sm:flex-row sm:justify-between">
              ...
              <div className="flex-1 text-center sm:text-left">
                ...
                <p className="mt-2 font-body text-sm text-muted-foreground">
                  Dominant pollutant: <strong className="text-foreground">{station.dominantPollutant.toUpperCase().replace("25", "2.5")}</strong>
                </p>
                <p className="font-mono text-[10px] text-muted-foreground">
                  Last measured: {station.time.s}
                </p>
              </div>
            </div>
            ...
            <div className="mt-6">
              <h3 className="flex items-center gap-2 font-display text-xs font-bold tracking-widest text-primary">
                <Activity className="h-4 w-4" /> POLLUTANT BREAKDOWN
              </h3>
                    ...
                    <div key={key} className="flex items-center gap-3">
                      ...
                      <div className="h-2 flex-1 overflow-hidden rounded-full bg-border">
                        <div
                          ...
                          style={{ width: `${pct}%`, backgroundColor: barLevel.color }}
                        />
                      </div>
            ...
            <div className="mt-6">
              <h3 className="flex items-center gap-2 font-display text-xs font-bold tracking-widest text-primary">
                <ShieldAlert className="h-4 w-4" /> AI HEALTH ADVISORY
              </h3>
            ...
            <div className="mt-5">
              <h3 className="flex items-center gap-2 font-display text-xs font-bold tracking-widest text-primary">
                <Factory className="h-4 w-4" /> AI POLLUTION SOURCE DETECTION
              </h3>
              <ul className="mt-2 space-y-1.5">
                {sources.map((s, i) => (
                  <li key={i} className="rounded-md border border-border bg-secondary/30 px-3 py-1.5 font-body text-sm text-secondary-foreground">
                    {s}
                  </li>
                ))}
              </ul>
            ...
            <div className="mt-5 pb-2">
              <h3 className="flex items-center gap-2 font-display text-xs font-bold tracking-widest text-primary">
                <Landmark className="h-4 w-4" /> GOVERNMENT POLICY RECOMMENDATIONS
              </h3>
